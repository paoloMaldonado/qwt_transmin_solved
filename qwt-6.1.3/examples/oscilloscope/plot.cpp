    ...
    d_timerId( -1 )
{
    ...
    d_label_amplitude = new QLabel(this);
    d_label_amplitude->setFont(font);

    d_label_frequency = new QLabel(this);
    d_label_frequency->setFont(font);
  
    d_label_layout = new QVBoxLayout(this);
    d_label_layout->setAlignment(Qt::AlignTop | Qt::AlignRight);
    d_label_layout->addWidget(d_label_amplitude);
    d_label_layout->addWidget(d_label_frequency);

    d_label_amplitude->setVisible(false);
    d_label_frequency->setVisible(false);
}
...
void Plot::resizeEvent( QResizeEvent *event )
{
    ...
    const QSize hint = d_label_amplitude->sizeHint();
}
...
void Plot::changeColorCurve(const QColor& color)
{
...
void Plot::updateLegendAmplitude(const double& amplitude)
{
    d_label_amplitude->setText("Amplitude: " + QString::number(amplitude));
}

void Plot::updateLegendFrequency(const double& frequency)
{
    d_label_frequency->setText("Frequency: " + QString::number(frequency) + "Hz");
}

void Plot::showLegend(const int& state)
{
    switch (state)
    {
    case Qt::Checked:
        d_label_amplitude->setVisible(true);
        d_label_frequency->setVisible(true);
        break;
    case Qt::Unchecked:
        d_label_amplitude->setVisible(false);
        d_label_frequency->setVisible(false);
...
void Plot::setLegend(const double& amplitude, const double& frequency)
{
    d_label_amplitude->setText("Amplitude: " + QString::number(amplitude));
    d_label_frequency->setText("Frequency: " + QString::number(frequency) + "Hz");
}
